 ...
 * @since 10.04.2012
 */
public class EntityManagerFactoryHolderBean extends LocalEntityManagerFactoryBean {
    ...
    public EntityManagerFactoryHolderBean(Provider<EntityManagerFactory> entityManagerFactoryProvider) {
